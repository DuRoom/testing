...
use DuRoom\Foundation\InstalledSite;
use DuRoom\Foundation\Paths;
use DuRoom\Testing\integration\Extend\BeginTransactionAndSetDatabase;
use DuRoom\Testing\integration\Extend\OverrideExtensionManagerForTests;
use DuRoom\Testing\integration\Extend\SetSettingsBeforeBoot;
...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \DuRoom\Foundation\InstalledApp
     */
    protected $app;

    /**
     * @return \DuRoom\Foundation\InstalledApp
     */
    ...
    /**
     * Some DuRoom code depends on config.php values. DuRoom doesn't
    ...
    /**
     * Send a full HTTP request through DuRoom's middleware stack.
     */
