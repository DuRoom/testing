...
namespace DuRoom\Testing\integration\Setup;

use DuRoom\Foundation\Paths;
use DuRoom\Install\AdminUser;
use DuRoom\Install\BaseUrl;
use DuRoom\Install\DatabaseConfig;
use DuRoom\Install\Installation;
use DuRoom\Install\Steps\ConnectToDatabase;
use DuRoom\Testing\integration\UsesTmpDir;
...
class SetupScript
{
    ...
    public function __construct()
    {
        ...
        $this->name = getenv('DB_DATABASE') ?: 'duroom_test';
    ...
    public function run()
    {
        ...
        echo "Test Config: DUROOM_TEST_TMP_DIR or DUROOM_TEST_TMP_DIR_LOCAL\n";
